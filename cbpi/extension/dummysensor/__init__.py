...
from cbpi.api.dataclasses import DataType, Fermenter, Kettle, Props
...
@parameters(
    [
        Property.Number(
            label="Pressure", configurable=True, description="Start Pressure"
        ),
        Property.Number(
            label="PressureIncrease",
            configurable=True,
            description="Pressure increase per hour",
        ),
        Property.Number(
            label="PressureDecrease",
            configurable=True,
            description="Pressure decrease per second on openm valve",
        ),
